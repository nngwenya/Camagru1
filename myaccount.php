...
if (isset($_POST['save']) && isset($_SESSION['username'])){
    ...
    $form_errors = array();
    $required_fields = array('id', 'firstname', 'lastname', 'email', 'username', 'password', 'country');
    ...
    if (empty($form_errors)){
       ...
       // $id = $_SESSION['id'];
        ...
        try{
            ...
            $to=$email;
            $msg= "Account updated.";   
            $subject="www.noreply@camagru.com - Account updated";
           ...
           Click Here :
           http://localhost:8080/Camagru/myaccount.php
           ...
           <br>Thank you!.<br>
            ...
            $result = "<p style='padding: 15px; color: green;'>Account was successfully updated!</p>";
...
<header>
    ...
    <div class="content">
        <ul>
            <li><a class="footer1" href="home.php">Back to home</a></li>
