...
<title>Gallery</title>
    ...
    <header>
            ...
            <div class="content" style="font-size:300%">
            <center><HEADER>WELCOME TO MY GALLARY</HEADER></center> 
  ...
  <?php
    ...
    ?>
           ...
           <?php if(isset($result)) echo $result; ?>
                    ...
                    <a class=del href="?delete_id=<?php echo $image['image_name']?>" action="" type='submit' name='delimg' style="float: right" onclick="return confirm('Are you sure you want to delete this image?')">Delete image</a>
                    <?php } ?>
...
?>
            ...
            function add1(element) {
                ...
                xhttp.open("POST", '/camagru/likes.php');
